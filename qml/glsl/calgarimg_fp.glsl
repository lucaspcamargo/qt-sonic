...
varying highp vec2 texCoord;
        ...
        void main(void)
        {
                vec2 coords = ( texCoord * rubyTextureSize );
        ...
        #ifdef RGB_BAR
                vec2 output_coords = floor( texCoord * rubyOutputSize);
        ...
        #ifdef RGB_TRIAD
                vec2 output_coords = floor(texCoord * rubyOutputSize / rubyInputSize * rubyTextureSize);
