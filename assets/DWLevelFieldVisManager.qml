...
{
    var c = Qt.createComponent("PLevelChunkVisual.qml");
    var cp = Qt.createComponent("PLevelChunkVisualPaletted.qml");

    if(c)
    {
        var paletted = String(visStubs[i]["source"]).indexOf("/mm/tileset/") >= 0;
