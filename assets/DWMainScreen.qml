...
Item {
    ...
    Repeater{
        ...
        ParticleSystem
        {
            ...
            ImageParticle
            {
                sprites: [Sprite{source: "ui/main/particle.png"; frameWidth: 100; frameHeight: 100; frameX: 100*(index%5); frameY: (index>=5? 100 : 0); frameCount: 1; frameDuration:2000}]
            }*/

            ImageParticle
            {
                source: ("ui/main/particle-%1.png").arg(index)
                scale: 1.1
            }
        }
