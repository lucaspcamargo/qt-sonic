...
ShaderEffect
{
    ...
    property url bgSource: inPrefix? levelData.urlPrefix + "bg/bg" + bgIndex + ".png" : "bgs/bg" + bgIndex + ".png"
    property url bgParallaxSource: inPrefix? levelData.urlPrefix + "bg/bg" + bgIndex + "-parallax.png" : "bgs/bg" + bgIndex + ".png"
