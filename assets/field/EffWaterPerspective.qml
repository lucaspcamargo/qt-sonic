...
ShaderEffect {
    ...
    fragmentShader: DWUtil.readTextFile(Qt.resolvedUrl("water-perspective/fragment-" + (reflectionEnabled? "reflection.glsl" : "no-reflection.glsl")))

    Image
    {
        id: imgSrc
        parent: null
        source: "water-perspective/water-texture.jpg"
    }
